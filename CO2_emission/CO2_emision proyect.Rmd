...
Fig1 <- ggplot(world_summary, aes(x = year)) +
  geom_line(aes(y = mean_co2, color = "Mean CO2 Emissions"), size = 1) +
  geom_line(aes(y = median_co2, color = "Median CO2 Emissions"), size = 1) +
  geom_line(aes(y = max_co2, color = "Max CO2 Emissions"), size = 1) +
  geom_line(aes(y = min_co2, color = "Min CO2 Emissions"), size = 1) +
